...
import EasyBooking from "../components/Homepage/EasyBooking";
import BigLayoutSection from "../components/Homepage/BigLayoutSection";
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background font-body">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            <div>
              ...
              <p className="text-muted-foreground mt-2 max-w-md">
                Discover our newest collection of books, handpicked just for
                your reading journey.
              </p>
            </div>
            <Link
              to={"/books-page"}
              className="mt-4 md:mt-0 inline-flex items-center gap-2 text-primary font-medium hover:gap-3 transition-all underline underline-offset-4"
            >
      ...
      {/* Easy Booking System Section */}
      <EasyBooking></EasyBooking>

      {/* Blog Layouts Section */}
      <BigLayoutSection></BigLayoutSection>
