...
const Books = () => {
  ...
  const loadBooks = async (query) => {
    ...
    const res = await fetch(
      `https://book-courier-server-kappa.vercel.app/search?search=${query}`
    );
      ...
      <div className="px-4 md:px-8 lg:px-16 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mt-4 max-w-2xl mx-auto">
            Browse through hundreds of books across different categories.
            Whether you're looking for fiction, non-fiction, or academic
            resources, find your next favorite read here.
          </p>
        </div>
      </div>
