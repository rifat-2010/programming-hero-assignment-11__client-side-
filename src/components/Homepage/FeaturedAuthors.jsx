...
const FeaturedAuthors = () => {
    ...
    <div class="container mx-auto px-6 md:w-11/12">
        <div class="text-center mb-16">
            ...
            <p class="max-w-2xl mx-auto mt-4 text-gray-600">Discover the brilliant minds shaping the future</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transition duration-300">
                ...
                <div class="mt-4 flex justify-center space-x-3">
                    <a href="#" class="text-primary hover:text-primary/70 transition">
            ...
            <div class="text-center p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transition duration-300">
                ...
                <p class="text-sm text-gray-600">Meta Platforms</p>
                <div class="mt-4 flex justify-center space-x-3">
                    <a href="#" class="text-primary hover:text-primary/70 transition">
            ...
            <div class="text-center p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transition duration-300">
                ...
                <p class="text-sm text-gray-600">Microsoft & Philanthropy</p>
                <div class="mt-4 flex justify-center space-x-3">
                    <a href="#" class="text-primary hover:text-primary/70 transition">
